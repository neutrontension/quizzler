...
class QuestionBank {
    // Question here is referring to the 'Question' class
    var list = [Question]()
    
    // initialization method will fill array with content using .append()
    init() {
        // Creating a quiz item and appending it to the list
        let item = Question(text: "Valentine\'s day is banned in Saudi Arabia.", correctAnswer: true)
        
        // Add the Question to the list of questions. Because the array is empty, we are adding each item to the end
        // of the array in a container, item. 
        list.append(item)
